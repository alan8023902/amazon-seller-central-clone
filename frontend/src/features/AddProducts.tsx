  ...
  return (
    <div className="max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500 pb-24">
      <div className="flex items-center justify-between mb-8 px-1">
        <h1 className="text-2xl font-black text-amazon-text uppercase tracking-tighter">Add Products to Inventory</h1>
      ...
      <Card className="mb-10 shadow-xl border-amazon-border relative overflow-hidden group">
        <div className="relative z-10">
          <h2 className="text-xl font-black mb-2 text-amazon-text tracking-tight uppercase">Search Amazon's Global Catalog</h2>
          <p className="text-sm-amz text-amazon-secondaryText mb-8 max-w-3xl font-medium">
            Avoid duplicate listings. If you're selling an item that's already on Amazon, you must use the existing product page. Search by identifier (ASIN, ISBN, EAN, or UPC) for maximum precision.
          </p>
          ...
          <form onSubmit={handleSearch} className="flex gap-0 group/search max-w-4xl relative">
            <div className="relative flex-1">
              <input 
                ...
                placeholder="Product name, UPC, EAN, ISBN or ASIN identifier"
                value={searchValue}
            ...
            >
              {isSearching ? <div className="w-5 h-5 border-2 border-amazon-text border-t-transparent rounded-full animate-spin"></div> : "Search Catalog"}
            </button>
          </form>
          ...
          <div className="mt-6 flex items-start gap-3 text-[11px] text-amazon-secondaryText bg-gray-50/80 p-3 rounded border border-gray-200 border-dashed max-w-2xl">
            ...
            <span className="font-medium">
              Important: Accurate identification ensures your products appear in the correct search results. Using an incorrect GTIN (Global Trade Item Number) may result in listing suppression.
            </span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div className="flex flex-col h-full bg-white border border-amazon-border rounded-sm shadow-amz-card hover:shadow-xl transition-all group cursor-pointer border-l-[6px] border-l-amazon-teal">
           <div className="p-6 flex-1">
              ...
              <h3 className="font-black text-base-amz mb-3 uppercase tracking-tight text-amazon-text">Private Label / New Brand</h3>
              <p className="text-[13px] text-amazon-secondaryText leading-relaxed font-medium">
                I'm adding a product not currently sold on Amazon. Use this to create entirely new listings for your own brand or unique products.
              </p>
           </div>
           <div className="px-6 py-4 bg-gray-50 border-t flex justify-between items-center group-hover:bg-blue-50 transition-colors">
              <span className="text-xs-amz font-black text-amazon-link uppercase tracking-widest">Create New Listing</span>
        ...
        <div className="flex flex-col h-full bg-white border border-amazon-border rounded-sm shadow-amz-card hover:shadow-xl transition-all group cursor-pointer border-l-[6px] border-l-blue-500">
           <div className="p-6 flex-1">
              ...
              <h3 className="font-black text-base-amz mb-3 uppercase tracking-tight text-amazon-text">Bulk Inventory Operations</h3>
              <p className="text-[13px] text-amazon-secondaryText leading-relaxed font-medium">
                I want to upload a file to add multiple products. Best for high-volume merchants with thousands of SKUs and complex variants.
              </p>
           </div>
           <div className="px-6 py-4 bg-gray-50 border-t flex justify-between items-center group-hover:bg-blue-50 transition-colors">
              <span className="text-xs-amz font-black text-amazon-link uppercase tracking-widest">Upload Inventory File</span>
              <ChevronRight size={16} className="text-amazon-teal group-hover:translate-x-1 transition-transform" />
           </div>
        </div>
        ...
        <div className="flex flex-col h-full bg-white border border-amazon-border rounded-sm shadow-amz-card hover:shadow-xl transition-all group cursor-pointer border-l-[6px] border-l-amazon-orange">
           <div className="p-6 flex-1">
              ...
              <h3 className="font-black text-base-amz mb-3 uppercase tracking-tight text-amazon-text">Application Center</h3>
              <p className="text-[13px] text-amazon-secondaryText leading-relaxed font-medium">
                Check the status of your product applications. View recently approved brands and categories that require authorization.
              </p>
           </div>
           <div className="px-6 py-4 bg-gray-50 border-t flex justify-between items-center group-hover:bg-blue-50 transition-colors">
              <span className="text-xs-amz font-black text-amazon-link uppercase tracking-widest">View Status</span>
              <ChevronRight size={16} className="text-amazon-teal group-hover:translate-x-1 transition-transform" />
           </div>
        </div>
      </div>
      ...
      <div className="mt-4 bg-white border border-amazon-border rounded-sm shadow-amz-card">
        <div className="px-6 py-4 border-b bg-gray-100 flex justify-between items-center">
          <span className="font-black text-xs-amz text-amazon-secondaryText uppercase tracking-[0.2em]">Audit Trail: Recent Submissions</span>
          <button className="text-[10px] font-black text-amazon-link uppercase tracking-widest hover:underline">View Historical Data ›</button>
        </div>
        <div className="p-16 text-center">
          ...
          <h4 className="text-base-amz font-black text-gray-400 uppercase tracking-widest">No active submissions</h4>
          <p className="text-xs text-gray-400 mt-2 font-medium max-w-sm mx-auto">You haven't submitted any new product applications or catalog updates in the last 30 days.</p>
        </div>
      </div>
    </div>
  );
